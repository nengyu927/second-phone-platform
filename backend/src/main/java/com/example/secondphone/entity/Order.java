...
public class Order {
    ...
    @Column(name="order_number",unique=true,length=40) private String orderNumber;
    ...
    @Column(name="shipping_fee",precision=12,scale=2) private BigDecimal shippingFee;
    ...
    @Column(name="shipping_status",length=30) private String shippingStatus;
    ...
    public String getShippingStatus(){return shippingStatus;} public void setShippingStatus(String v){shippingStatus=v;}
